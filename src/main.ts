...
//     userList = []
//     users.innerHTML = ''
//     axios.get('http://localhost:3333/api/user').then((response: { data: any[]; }) => {
//         if(response.data){
...
// async function updateUser(clickedIndex: string | number) {
...
//     //     name: "name Updated"
//     // }
//     // await axios.put(`http://localhost:3333/api/user/update/${userId}`, payload).then((response: { data: any; }) => {
//     //    console.log('console', response.data);
//     // });
//     // getUsers()
// }

// async function deleteUser(clickedIndex: string | number) {
//     // const userId = userList[clickedIndex].id
